...
from src.utils import insert_data_into_tables, create_tables, create_database
...
def main():
    ...
    database_menu_items = ["Получить список всех компаний и количество вакансий у каждой компании",
